...
public class MainActivity extends AppCompatActivity {
    ...
    private void renderWeather(JSONObject json) {
        try { // Ответы:
            ...
            // JSONObject details = json.getJSONArray("weather").getJSONObject(0) - первый элемент массива метеорологических данных. // details.getInt("id") - идентификатор погоды\
            ...
            //String updatedOn = df.format(new Date(json.getLong("dt")*1000)); - время получения информации системой // json.getJSONObject("sys").getLong("sunrise") - время восхода //
